...
/*
File con le mappe delle rule action, operators e values
Vengono standardizzati gli eventi secondo gli action type definiti dal linguaggio
 */
...
const OperatorsMap = Immutable.Map([
    [
        Operators.EQUAL,
        {
            subj_type: [
                InteractiveObjectsTypes.TRANSITION,
                InteractiveObjectsTypes.FLAG,
                InteractiveObjectsTypes.NUMBER,
                InteractiveObjectsTypes.PLAYTIME,
                InteractiveObjectsTypes.SCORE,
                InteractiveObjectsTypes.BUTTON,
